    ...
    >
      ...
      <dl className="mt-6 space-y-4">
        ...
        <div className="flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-600">
          ...
          <dd className="text-sm font-medium">{formatCurrencyString({currency:"RON", value: shippingAmount}) }</dd>
        </div>
        <div className="flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-600">
          <dt className="text-base font-medium">Order total</dt>
          <dd className="text-base font-medium">{formatCurrencyString({currency:"RON", value: totalAmount}) }</dd>
        </div>
      </dl>
